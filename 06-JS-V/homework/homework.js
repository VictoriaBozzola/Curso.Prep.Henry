...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function() {
    ...
    var stringInvertida = ''; //Como var contador, solo que esto es para juntar los caracteres

    for(var i = this.length - 1; i>=0; i--) { //Lo hace al reves para que empiece del ultimo caracter al primero (va restando)
